...
- Date format: [`clean_date_format`](https://github.com/mft2023/LibraryProject/blob/b27b4965254068d958ec74700d883622952847ee/Analysis.py#L17) function (input: string, output: datetime or '').  
  This function tries to convert the string into datetime. The dates are separated by special characters, therefore, turn the special characters into '-' if they are not located in the start or end location.  
